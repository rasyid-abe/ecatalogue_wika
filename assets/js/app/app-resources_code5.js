    ...
    return {
        ...
        editData : function() {
            $("#table").on("click", ".modalUbah", function() {
                ...
                $('.modal-content form').attr('action', App.baseUrl+"resources_code5/update");

                const id = $(this).data('id');
                $.ajax({
                    url: App.baseUrl+"resources_code5/edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
        ...
        selectKategori : function(){
            $('.kategori_show').on('click', function() {
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_kategori",
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
        ...
        selectJenis : function(){
            $('#kategori').on('change', function() {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_jenis",
        ...
        selectLevel3 : function(){
            $('#jenis').on('change', function() {
                let jenis = $('#jenis').val();
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_level3",
                    data: {jenis:jenis},
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
        ...
        selectLevel4 : function(){
            $('#level3').on('change', function() {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_level4",
                    data: {level3:level3},
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
        ...
        jenisShow : function(){
            $("#table").on("click", ".modalUbah", function() {
                const id = $(this).data('id');
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_jenis_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_level1_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_level3_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code5/get_level4_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
