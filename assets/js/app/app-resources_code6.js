    ...
    return {
        ...
        clearForm : function() {
            $('.show_modal').on('click', function() {
                ...
                $('#level4').html('<option value="">- Pilih -</option>').prop('disabled', true);
                $('#level5').html('<option value="">- Pilih -</option>').prop('disabled', true);
                $('#name').val('');
                $('#desc').val('');
                $('#id').val('');
            })
        ...
        editData : function() {
            $("#table").on("click", ".modalUbah", function() {
                ...
                $('.modal-content form').attr('action', App.baseUrl+"resources_code6/update");

                const id = $(this).data('id');
                $.ajax({
                    url: App.baseUrl+"resources_code6/edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
        ...
        selectKategori : function(){
            $('.kategori_show').on('click', function() {
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_kategori",
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
        ...
        selectJenis : function(){
            $('#kategori').on('change', function() {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_jenis",
        ...
        selectLevel3 : function(){
            $('#jenis').on('change', function() {
                let jenis = $('#jenis').val();
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level3",
                    data: {jenis:jenis},
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
        ...
        selectLevel4 : function(){
            $('#level3').on('change', function() {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level4",
                    data: {level3:level3},
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $.each(data, function(key, val){
                            level4 += '<option value="'+val.code+'">'+val.code +' - '+ val.name+'</option>';
                        });
        ...
        selectLevel5 : function(){
            $('#level4').on('change', function() {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level5",
                    data: {level4:level4},
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $.each(data, function(key, val){
                            level5 += '<option value="'+val.code+'">'+val.code +' - '+ val.name+'</option>';
                        });
        ...
        jenisShow : function(){
            $("#table").on("click", ".modalUbah", function() {
                const id = $(this).data('id');
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_jenis_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level1_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level3_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level4_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
                        level4 = '<option value="'+res.code+'">'+res.code +' - '+ res.name+'</option>';
                        // $.each(res.data, function(key, val){
                        //     if (res.code != val.code) {
                        //         level4 += '<option value="'+val.code+'">'+val.code +' - '+ val.name+'</option>';
                        //     }
                        // });
                        $('#level4').html(level4).prop('disabled', true);;
                    }
                })

                $.ajax({
                    url: App.baseUrl+"resources_code6/get_level5_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
                        level5 = '<option value="'+res.code+'">'+res.code +' - '+ res.name+'</option>';
                        // $.each(res.data, function(key, val){
                        //     if (res.code != val.code) {
                        //         level5 += '<option value="'+val.code+'">'+val.code +' - '+ val.name+'</option>';
                        //     }
                        // });
                        $('#level5').html(level5).prop('disabled', true);;
                    }
                })
            })
        },
