    ...
    return {
        ...
        initEvent : function(){
            App.table = $('#table').DataTable({
                ...
                "ajax":{
                    "url": App.baseUrl+"category/dataList",
                    "dataType": "json",
                    "type": "POST",
                },
                "columns": [
            ...
            // add_btn = '<a href="'+App.baseUrl+'category/create" class="btn btn-sm btn-primary ml-2 mt-1"><i class="fa fa-plus"></i> Jabatan</a>';
