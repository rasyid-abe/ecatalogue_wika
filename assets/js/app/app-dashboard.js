    ...
    return {
        ...
        yearFilter : function(){
            $('#year_filter').on('change', function(){
                App.initForecastChart($('#bulan_filter').val(), $(this).val());
            });
            $('#bulan_filter').on('change', function(){
                App.initForecastChart($(this).val(), $('#year_filter').val());
            });
        },
        initForecastChart : function(){
            ...
            $('#option_chart_bulan').on('change', function() {
                month = $('#option_chart_bulan').val();
                ajax_call(month);
            })

            function ajax_call(month) {
                $.ajax({
                    method: "POST",
                    url:  App.baseUrl+"dashboard/get_data_chart_forecast",
                    data: {month : month},
                    beforeSend : function(){
                        $('.loading').show();
                    },
            ...
            $.ajax({
                ...
                success : function(result)
                {
                    ...
                    Highcharts.chart('wikachart', {
                        ...
                        yAxis : {
                            title: {
                                text: '<span onclick = "App.modal_po_vendor_wika(\'-1\', '+tahun+', '+category_id+')" style="cursor : pointer">Penyerapan <b>' + App.toRp(result.total_penyerapan) + '</b></span>',
                                useHTML : true,
                                margin : 0,
                            },
                            labels: {
        ...
        initWikaChartSemen : function(tahun = null)
        {
            if(tahun == null)
            {
                tahun = new Date().getFullYear()
            }
            var vendor_index, nama_vendor, category_id = 70;
            $.ajax({
                url : App.baseUrl+'dashboard/get_monev_chart/' + tahun + '/' + category_id,
                type : 'GET',
                dataType : 'json',
                ...
                {
                    vendor_index = result.vendor_index;
                    Highcharts.chart('wikachartSemen', {
                        chart: {
                            type: 'bar',
                            //marginLeft: 50,
                            marginBottom: 120,
        ...
        initDeptChart : function(tahun = null)
        {
            if(tahun == null)
            {
                tahun = new Date().getFullYear()
            ...
            $.ajax({
                url : App.baseUrl+'dashboard/get_total_penyerapan_dept/' + tahun,
                type : 'GET',
                dataType : 'json',
                success : function(result)
                {
                    dept_index = result.dept_index;
                                ...
                                point: {
                                    events : {
                                        click : function(e){
                                            ...
                                            nama_dept = result.category[e.point.index];
                                            modal_po_vendor(dept_id, bulan)
                                        },
                                    },
                                },
                            },
            ...
            var modal_po_vendor = function(dept_id, bulan)
            {
                $('#modal_po_dept').modal('show');
                $('#modal_po_dept').find('.judul').html('' + nama_dept + ' Bulan ' + App.nama_bulan(bulan - 1) + ' Tahun ' + tahun);
                $('#modal_po_dept')
                .find('.table-modal tbody')
                .html('<tr><td colspan="7" align="center"><i class="fa fa-spin fa-spinner"></i>Loading</td></tr>')
                .load(App.baseUrl + 'dashboard/get_detail_penyerapan_dept/' + dept_id + '/' + bulan + '/' + tahun);
            }
        },
        ...
        penyerapan_volume_vendor_chart : function (tahun = null)
        {
            ...
            $.ajax({
                url : App.baseUrl+'dashboard/get_penyerapan_volume_vendor/' + tahun,
                type : 'GET',
                dataType : 'json',
                success : function(result)
                {
        ...
        penyerapan_vendor_chart : function (tahun = null)
        {
            ...
            $.ajax({
                url : App.baseUrl+'dashboard/get_penyerapan_vendor/' + tahun,
                type : 'GET',
                dataType : 'json',
                success : function(result)
                {
        ...
        if ($('#wikachartSemen').length > 0)
        {
            App.initWikaChartSemen();
        }
