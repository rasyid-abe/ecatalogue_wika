    ...
    return {
        ...
        editData : function() {
            $("#table").on("click", ".modalUbah", function() {
                ...
                $('.modal-content form').attr('action', App.baseUrl+"resources_code3/update");

                const id = $(this).data('id');
                $.ajax({
                    url: App.baseUrl+"resources_code3/edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
        ...
        selectKategori : function(){
            $('.kategori_show').on('click', function() {
                $.ajax({
                    url: App.baseUrl+"resources_code3/get_kategori",
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
        ...
        selectJenis : function(){
            $('#kategori').on('change', function() {
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code3/get_jenis",
        ...
        jenisShow : function(){
            $("#table").on("click", ".jenis_show", function() {
                const id = $(this).data('id');
                $.ajax({
                    url: App.baseUrl+"resources_code3/get_jenis_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                ...
                $.ajax({
                    url: App.baseUrl+"resources_code3/get_level1_edit",
                    data: {id:id},
                    method: 'post',
                    dataType: 'json',
                    success: function(res) {
        ...
        matgis : function(){
            $('#jenis').on('change', function() {
                let jenis = $('#jenis').val()
                $.ajax({
                    url: App.baseUrl+"resources_code3/check_matgis",
                    data: {jenis:jenis},
                    method: 'post',
                    dataType: 'json',
                    success: function(data) {
