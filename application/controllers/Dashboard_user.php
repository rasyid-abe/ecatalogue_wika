...
class Dashboard_user extends Admin_Controller {
	...
	public function index()
	{
        ...
        if($this->data['is_can_read']){
            $query = $this->Order_model->get_total_dana_order(['created_by' => $this->data['users']->id]);
            ...
            $this->data['content'] = 'admin/dashboard_user';
		}else{
			redirect('restrict');
		}
