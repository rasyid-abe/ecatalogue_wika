        ...
        if(!empty($datas))
        {
            foreach ($datas as $key=>$data)
            {
            	...
            	if($this->data['is_can_edit']){
            		$edit_url = "<a href='".base_url()."privileges/edit/".$data->id."' class='btn btn-sm btn-info white'><i class='fa fa-pencil'></i> Ubah</a>";
            	}

            	// if($this->data['is_can_delete']){
            	// 	$delete_url = "<a  href='#' url='".base_url()."privileges/destroy/".$data->id."' class='btn btn-sm btn-danger white delete'><i class='fa fa-trash-o'></i> Hapus</a>";
            	// }
