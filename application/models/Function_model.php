...
class Function_model extends CI_Model
{
    ...
    public function getAllMenuFunctionBy()
    {
        $sql = "
            SELECT m.id, m.name, f.id function_id, f.name function_name
            FROM menu_function mf
            LEFT JOIN menu m ON mf.menu_id = m.id
            LEFT JOIN function f ON mf.function_id = f.id
        ";
