      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <select id="specification_id" name="specification_id" class="form-control" data-selectjs="true">
                ...
                if($specification)
                {
                    foreach ($specification as $key => $value)
                    {
                      ...
                      ?>
                      <option value="<?php echo $value->id;?>" data-code-cat="<?= $value->category_code.$value->code ?>"><?php echo $value->name;?></option>
                    <?php
          ...
          <div class="form-group col-12 row">
            <div class="col-sm-6">
                ...
                <input class="form-control" type="text" id="code_1" name="code_1" autocomplete="off" required placeholder="Kode Sumber Daya" readonly>
            </div>
            <div class="col-sm-6">
                <label for="">Kode Spesifikasi</label>
                <input class="form-control" type="text" id="code" name="code" autocomplete="off" placeholder="Kode Spesifikasi" maxlength="25">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            ...
            <input class="form-control number" value="" type="text" id="default_weight" name="default_weight" autocomplete="off" required>
          </div>
        </div>
      </div>
    </div>
