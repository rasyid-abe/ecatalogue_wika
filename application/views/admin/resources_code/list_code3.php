...
<div class="modal fade" id="form_code1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="width: 665px;">
        <div class="modal-content">
            ...
            <form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('resources_code3/create') ?>">
...
<section class="content">
    <div class="box box-default color-palette-box">
        <form class="" action="<?php echo base_url('resources_code3/status_ids') ?>" method="post">
                    ...
                    <tbody>
                        <?php foreach ($data as $var) :
                            ...
                            if ($var['code'] != '') {
                                ...
                                $inc = $this->Resources_code_model->increment($var['parent_code'], 3);
                                $code = substr($var['parent_code'], 0, 2) . $inc['data'] . '000';
                                $text = 'yellow';
                            }
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    if ($is_can_edit) {
                                    ?>
                                        <a href="#" class="btn btn-xs btn-warning modalUbah jenis_show aaa" data-toggle="modal" data-target="#form_code1" data-id="<?php echo $var['resources_code_id'] ?>"><i class='fa fa-pencil'></i></a>
                                    <?php
                                    }
                                    ?>
                                </td>
...
<script data-main="<?php echo base_url() ?>assets/js/main/main-resources_code3" src="<?php echo base_url() ?>assets/js/require.js"></script>