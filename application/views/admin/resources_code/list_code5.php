...
<div class="modal fade" id="form_code1" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog" style="width: 665px;">
        <div class="modal-content">
            ...
            <form id="form" method="post" enctype="multipart/form-data" action="<?php echo base_url('resources_code5/create') ?>">
...
<section class="content">
    <div class="box box-default color-palette-box">
        <form class="" action="<?php echo base_url('resources_code5/status_ids') ?>" method="post">
                    ...
                    <tbody>
                        <?php foreach ($data as $var) :
                            ...
                            if ($var['code'] != '') {
                                ...
                                $inc = $this->Resources_code_model->increment($var['parent_code'], 5);
                                $code = substr($var['parent_code'], 0, 4) . $inc['data'] . '0';
                                $text = 'yellow';
                            }
                        ?>
                            <tr>
...
<script data-main="<?php echo base_url() ?>assets/js/main/main-resources_code5" src="<?php echo base_url() ?>assets/js/require.js"></script>