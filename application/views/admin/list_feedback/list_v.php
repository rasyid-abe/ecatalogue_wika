...
<section class="content">
           ...
           <table class="table table-striped display" id="table">
             <thead>
               <tr>
                   ...
                   <th width="20%">Kategori Feedback</th>
 ...
 <div class="modal fade" id="detail-list-feedback">
   <div class="modal-dialog">
     <div class="modal-content">
       ...
       <div class="modal-footer">
         <button type="button" class="btn btn-sm btn-default alert-reject" data-dismiss="modal">Tutup</button>
       </div>
     </div>
   </div>
 </div>
