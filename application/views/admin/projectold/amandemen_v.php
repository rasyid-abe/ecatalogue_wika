    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
            ...
            <h3 class="box-title"><i class="fa fa-tag"></i> Amandemen Kontrak</h3>
            </div>
          <form class="form-horizontal" id="form" method="POST" action="" enctype="multipart/form-data">
            <div class="box-body">
              <?php if(!empty($this->session->flashdata('message_error'))){?>
                ...
                <div class="form-group row">
                 ...
                 <div class="col-sm-9">
                   <input type="name" class="form-control" id="name" placeholder="Nama" name="name" value="<?= $name ?>" readonly>
                 </div>
               </div>
               <!-- <div class="form-group row">
                <label for="inputEmail3" class="col-sm-3 control-label">No Surat</label>
                <div class="col-sm-9">
                  <input type="name" class="form-control" id="no_surat" placeholder="No Surat" name="no_surat" value="<?= $no_surat ?>" readonly>
                </div>
              </div> -->
              <div class="form-group row">
               ...
               <div class="col-sm-9">
                   <div class="" data-datepicker="true">
                     <input class="form-control" type="text" id="tgl" name="tgl" autocomplete="off" value="<?= $tanggal ?>" readonly>
                   </div>
               </div>
             </div>
             <div class="form-group row">
              ...
              <div class="col-sm-9">
                <textarea class="form-control" id="deskripsi" name="deskripsi" readonly><?= $description ?></textarea>
              </div>
            </div>
            <div class="form-group row">
              <label for="inputPassword3" class="col-sm-3 control-label">Departemen</label>
              <div class="col-sm-9">
                 <select id="departemen" name="departemen[]" class="form-control" data-selectjs="true" multiple="multiple" disabled>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                  <select class="form-control" id="users" name="users[]" data-selectjs="true" multiple="multiple" disabled>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  <select class="form-control" id="vendor_id" name="vendor_id" data-selectjs="true" disabled>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                  <select class="form-control" id="product_id_amandemen" name="product_id[]" data-selectjs="true" multiple="true">
                      ...
                      if($products)
                      {
                          foreach($products as $product)
                          {
                              ...
                              {
                                  $sel = "selected";
                                  $nm_product[$product->id] = $product->name;
                              }
                              ?>
            ...
            <?php
            /*
            foreach($arr_products as $v)
            {
                ?>
                <div class="form-group product-amandenen">
                    <label for="inputPassword3" class="col-sm-3 control-label"><?php echo isset($nm_product[$v]) ? $nm_product[$v] : '' ?></label>
                    <div class="col-sm-9">
                            <input class="form-control" type="text" name="harga_product[<?= $v ?>]" id="harga_product_<?= $v ?>" autocomplete="off" onkeyup="App.format(this)">
                    </div>
                </div>
                <?php
            }
            */
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    <input class="form-control" type="text" id="no_contract" name="no_contract" autocomplete="off" value="<?= $no_contract ?>" readonly>
                </div>
             </div>
            <div class="form-group">
             ...
             <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-9">
                    <select id="departemen_pemantau" name="departemen_pemantau" class="form-control" data-selectjs="true" disabled>
               ...
               <div class="form-group row">
                 ...
                 <div class="col-sm-9">
                     <select class="form-control" id="user_pemantau" name="user_pemantau" data-selectjs="true" disabled>
                         <option value="" disabled>Pilih User</option>
                         <?php
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-sm-9">
                       <select class="form-control" id="payment_method" name="payment_method" data-selectjs="true" disabled>
                           ...
                           foreach ($payment_method as $key => $value) {
                               ...
                               ?>
                               <option value="<?php echo $value->id?>" <?= $sel ?>><?php echo $value->full_name?></option>
                           <?php } ?>
                       </select>
                   </div>
                 </div>
