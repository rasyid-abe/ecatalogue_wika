    ...
    <div class="full-width padding">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tag"></i> Edit Transportasi</h3>
            </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="origin_location_id" data-selectjs="true">
                                <option value="" disabled selected>Pilih Origin</option>
                                <?php
                                echo array_to_options($location, $data->origin_location_id);
                                 ?>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="">Destinasi</label>
                            <select class="form-control" name="destination_location_id" data-selectjs="true">
                                <option value="" disabled selected>Pilih Destinasi</option>
                                <?php
                                echo array_to_options($location, $data->destination_location_id);
                                 ?>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="text" name="price" id="price" value="<?php echo rupiah($data->price) ?>" onkeyup="App.format(this)" class="form-control">
                    </div>
