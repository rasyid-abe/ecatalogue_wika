    ...
    <div class="full-width padding">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tag"></i> Amandemen Kontrak Transportasi</h3>
            </div>
            <form id="form" method="POST" action="" enctype="multipart/form-data" autocomplete="off">
                <input type="hidden" name="kontrak_transportasi_id" value="<?php echo $id ?>">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="no_contract" value="<?php echo $data->no_contract ?>" class="form-control" readonly>
                    </div>
                    <div class="form-group">
                        <label for="">Vendor</label>
                        <select class="form-control" name="vendor_id" data-selectjs="true" disabled>
                    ...
                    <div class="form-group">
                        ...
                        <div class="">
                            <input class="form-control" type="text" id="tgl_kontrak" name="tgl_kontrak" autocomplete="off" value="<?= $data->tgl_kontrak ?>" readonly>
                        </div>
                    </div>
                    <!--<div class="form-group">
                        <label for="">Data Trailer</label>
                        <input type="text" name="data_trailer" value="<?php echo $data->data_trailer ?>" class="form-control" readonly>
                    </div> -->
