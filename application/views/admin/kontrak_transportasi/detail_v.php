...
<section class="content">
 <div class="box box-default color-palette-box">
   ...
   <h3 class="box-title"><i class="fa fa-tag"></i> Detail Amandemen Transportasi <?= $detail_amandemen->no_contract ?></h3>
...
<input type="hidden" id="kontrak_transportasi_id" value="<?= $kontrak_transportasi_id ?>">
<script
 data-main="<?php echo base_url()?>assets/js/main/main-kontrak_transportasi"
