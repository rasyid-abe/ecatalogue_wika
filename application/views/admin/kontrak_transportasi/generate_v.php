<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="<?= base_url() . $cont ?>"><i class="fa fa-book"></i>Kontrak Transportasi</a></li>
...
<input type="hidden" id="id_kontrak_transportasi" value="<?= $id ?>">;

<script data-main="<?php echo base_url() ?>assets/js/main/main-kontrak_transportasi" src="<?php echo base_url() ?>assets/js/require.js"></script>