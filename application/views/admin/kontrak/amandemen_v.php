            ...
            <form class="form-horizontal" id="form" method="POST" action="" enctype="multipart/form-data">
              <div class="box-body">
                ...
                <div class="form-group ">
                  ...
                  <div class="col-sm-9">
                    <select id="level1" name="level1" class="form-control" data-selectjs="true" disabled>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-9">
                    <select id="level2" name="level2" class="form-control" data-selectjs="true" disabled>
                      <option value="" disabled selected>Pilih </option>
                      <?php
