...
<section class="content">
	<div class="box box-default color-palette-box">
		...
		<h3 class="box-title"><i class="fa fa-tag"></i> <?php echo ucwords( 'List Detail Asset / Peralatan' ) ?></h3>
		<?php
			if($is_can_create){
		?>
 ...
 <script data-main="<?php echo base_url( 'assets/js/main/main-asset_detail' )?>" src="<?php echo base_url()?>assets/js/require.js"></script>
