          ...
          <div class="form-group col-12 row">
            <div class="col-sm-6">
              ...
              <div class="" data-datepicker="true">
                <input class="form-control" type="text" value="" id="start_date" name="start_date" autocomplete="off">
              </div>
            </div>
            <div class="col-sm-6">
              <label for="">Tanggal Akhir</label>
              <div class="" data-datepicker="true">
                <input class="form-control" type="text" value="" id="end_date" name="end_date" autocomplete="off">
              </div>
            </div>
          </div>
          <div class="form-group col-12 row">
