                ...
                <table class="table table-sm table-striped" width="100%" id="sync_table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Harga</th>
                            <th class="text-right border_right">QTY</th>
                            <th>contract_item_id</th>
                            <th>Departemen</th>
                            <th>Vendor</th>
                            <th>Harga</th>
                            <th>QTY</th>
                    ...
                    <tbody>
                        <?php foreach ($data as $key => $value): ?>
                            <tr>
                                <td><?= $value['api_contract_item_id'] ?></td>
                                <td><?= $value['api_subject_work'] ?></td>
                                <td><?= $value['api_ptm_dept_name'] ?></td>
                                <td><?= $value['api_vendor_name'] ?></td>
                                <td><?= $value['api_start_date'] ?></td>
                                <td><?= $value['api_end_date'] ?></td>
                                <td><?= $value['api_currency'] ?></td>
                                <td><?= $value['api_item_code'] ?></td>
                                <td><?= $value['api_long_description'] ?></td>
                                <td class="text-right"><?= $value['api_price'] ?></td>
                                <td class="text-right border_right"><?= $value['api_qty'] ?></td>
                                <td><?= $value['api_contract_item_id'] ?></td>
                                <td><?= $value['sql_departemen'] ?></td>
                                <td><?= $value['sql_vendor'] ?></td>
                                <td class="text-right"><?= $value['sql_harga'] ?></td>
                                <td class="text-right"><?= $value['sql_volume'] ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
