                ...
                <table class="table table-sm table-striped" id="sync_table">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Name</th>
                            <th>api_kddivisi</th>
                            <th>api_updated_date</th>
                            <th>api_alamatproyek</th>
                            <th class="border_right">Manager Proyek</th>
                            <th>api_telp_manager</th>
                            <th>No SPK</th>
                            <th>Name</th>
                    ...
                    <tbody>
                        <?php foreach ($data as $key => $value): ?>
                            <tr>
                                ...
                                <td><?= $value['api_kode_spk'] ?></td>
                                <td><?= $value['api_nama_spk'] ?></td>
                                <td><?= $value['api_kddivisi'] ?></td>
                                <td><?= $value['api_updated_date'] ?></td>
                                <td><?= $value['api_alamatproyek'] ?></td>
                                <td class="border_right"><?= $value['api_manager_proyek'] ?></td>
                                <td><?= $value['api_telp_manager'] ?></td>
                                <td><?= $value['sql_no_spk'] ?></td>
                                <td><?= $value['sql_name'] ?></td>
                                <td><?= $value['sql_contact_person'] ?></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
