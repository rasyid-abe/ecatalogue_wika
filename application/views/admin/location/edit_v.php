      ...
      <div class="row">
        <div class="col-md-12">
            <div class="form-group">
              ...
              <input class="form-control number" type="text" id="location_id" name="location_id" autocomplete="off" readonly value="<?= $id ?>">
            </div>
          <div class="form-group">
         ...
         <div class="box-footer">
          <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 text-right">
              ...
              <a href="<?php echo base_url();?>location" class="btn btn-primary btn-danger">Batal</a>
            </div>
        </div>
      </div>
    </form>
