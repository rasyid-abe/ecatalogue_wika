<section class="content">
  <div class="box box-default color-palette-box">
    ...
    <h3 class="box-title"><i class="fa fa-tag"></i> <?= ucwords($page) ?></h3>
    </div>
      ...
      <div class="row">
        ...
        <div class="form-group">
          ...
          <select name = "category_id" id = "category_id" class="form-control" data-selectjs="true">
              ...
              {
                  $selected = "";
                  if($category_id == $v->id) $selected = "selected";
                  ?>
          ...
          <div class="form-group col-12 row">
            <div class="col-sm-6">
                ...
                <input class="form-control" type="text" id="code_1" name="code_1" autocomplete="off" required placeholder="Kode Jenis" readonly value="<?= $category_code ?>">
            </div>
            <div class="col-sm-6">
                <label for="">Kode Sumber Daya</label>
                <input class="form-control" type="text" id="code" name="code" autocomplete="off" placeholder="Kode Sumber Daya" maxlength="25" value="<?php echo $code;?>">
            </div>
          </div>
          <!-- <div class="form-group">
