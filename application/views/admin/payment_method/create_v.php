      ...
      <div class="row">
        <div class="col-md-12">
          <div class="form-group">
            <select id="enum_payment_method_id" name="enum_payment_method_id" class="form-control" data-selectjs="true">
          ...
          <div class="form-group">
            ...
            <input class="form-control number" type="text" id="day" name="day" autocomplete="off" required>
          </div>
          <div class="form-group">
