    ...
    <div class="full-width padding">
        <div class="box box-default color-palette-box">
            <div class="box-header with-border">
                <h3 class="box-title"><i class="fa fa-tag"></i> Edit Asuransi</h3>
            </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="" data-datepicker="true">
                            <input class="form-control" type="text" id="tgl_kontrak" name="tgl_kontrak" value="<?= $data->tgl_kontrak ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
                            <label for="">Tahun</label>
                            <input class="form-control number" type="text" id="tahun" name="tahun" autocomplete="off" value="<?= $data->tahun ?>" maxlength="4">
                        </div>
                        <div class="col-md-6">
                            <label for="">No Kargo Insurance</label>
                            <input class="form-control" type="text" id="no_cargo_insurance" name="no_cargo_insurance" autocomplete="off" value="<?= $data->no_cargo_insurance ?>">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-md-6">
